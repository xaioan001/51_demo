...
//	GPIO_InitStructure.Mode = GPIO_PullUp;		//指定IO的输入或输出方式,GPIO_PullUp,GPIO_HighZ,GPIO_OUT_OD,GPIO_OUT_PP
	...
	P1_MODE_IN_HIZ(GPIO_Pin_0|GPIO_Pin_1);		//P1.0~P1.7 设置为高阻输入
	P5_MODE_IN_HIZ(GPIO_Pin_0|GPIO_Pin_1);		//P1.0~P1.7 设置为高阻输入
...
void	RTC_config(void)
{
	...
	RTC_InitStructure.RTC_Day    = 15;					//RTC 日, 01~31
	RTC_InitStructure.RTC_Hour   = 11;					//RTC 时, 00~23
	RTC_InitStructure.RTC_Min    = 42;					//RTC 分, 00~59
	RTC_InitStructure.RTC_Sec    = 55;					//RTC 秒, 00~59
	RTC_InitStructure.RTC_Ssec   = 00;					//RTC 1/128秒, 00~127

	RTC_InitStructure.RTC_ALAHour= 11;					//RTC 闹钟时, 00~23
	RTC_InitStructure.RTC_ALAMin = 44;					//RTC 闹钟分, 00~59
